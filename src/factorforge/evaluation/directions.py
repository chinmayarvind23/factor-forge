...
DirectionProfile = Literal[
    "baseline", "complete-evidence-v1", "qwen3-baseline-v1", "qwen3-coherent-v1"
]
...
def direction_prompt(profile: DirectionProfile) -> str:
    ...
    if profile in ("baseline", "qwen3-baseline-v1", "qwen3-coherent-v1"):
    ...
    *,
    ...
    for case in suite.cases:
        ...
        result = _judge_direction(
            ...
            artifacts,
            system=prompt,
            model="qwen3:8b" if profile.startswith("qwen3-") else "llama3.1:8b",
            coherent_wire=profile == "qwen3-coherent-v1",
        )
