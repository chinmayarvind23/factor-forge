...
Use the full local project to run research workflows.

Build: `python scripts/build_space.py`. The builder executes the real monthly engine
and verifies every artifact reachable from each result before publication.
