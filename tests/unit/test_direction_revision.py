...
def test_revision_retains_context_and_one_new_observation(outcome: str) -> None:
    ...
    result = revise_direction(request, Provider(), store)
    ...
    assert record["schema_version"] == "direction-revision-record-v1"
